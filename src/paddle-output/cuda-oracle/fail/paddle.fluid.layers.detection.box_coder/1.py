results = dict()
import paddle
arg_1_tensor = paddle.randint(-2048,1024,[10, 4], dtype=paddle.float32)
arg_1 = arg_1_tensor.clone()
arg_2_tensor = paddle.randint(-4096,512,[10, 4], dtype=paddle.float32)
arg_2 = arg_2_tensor.clone()
arg_3_tensor = paddle.randint(-4096,16,[2, 21, 4], dtype=paddle.float32)
