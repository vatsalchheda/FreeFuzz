...
arg_5 = None
try:
  results["res_cpu"] = paddle.nn.functional.bilinear(arg_1,arg_2,arg_3,arg_4,arg_5,)
...
try:
  results["res_gpu"] = paddle.nn.functional.bilinear(arg_1,arg_2,arg_3,arg_4,arg_5,)
except Exception as e:
