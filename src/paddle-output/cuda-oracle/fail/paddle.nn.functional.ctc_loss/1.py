...
arg_6 = "none"
try:
  results["res_cpu"] = paddle.nn.functional.ctc_loss(arg_1,arg_2,arg_3,arg_4,blank=arg_5,reduction=arg_6,)
...
try:
  results["res_gpu"] = paddle.nn.functional.ctc_loss(arg_1,arg_2,arg_3,arg_4,blank=arg_5,reduction=arg_6,)
except Exception as e:
