...
try:
  results["res_cpu"] = paddle.nn.functional.linear(x=arg_1,weight=arg_2,bias=arg_3,)
...
try:
  results["res_gpu"] = paddle.nn.functional.linear(x=arg_1,weight=arg_2,bias=arg_3,)
except Exception as e:
