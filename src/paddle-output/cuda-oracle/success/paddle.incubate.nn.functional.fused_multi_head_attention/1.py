...
arg_2_tensor = paddle.rand([3, 0, 0, 128], dtype=paddle.float32)
...
arg_5 = None
arg_6 = None
arg_7_tensor = paddle.rand([128], dtype=paddle.float32)
...
arg_12 = None
arg_13_tensor = paddle.rand([2, 2, 4, 4], dtype=paddle.float32)
...
arg_10 = arg_10_tensor.clone().cuda()
arg_11 = arg_11_tensor.clone().cuda()
arg_13 = arg_13_tensor.clone().cuda()
try:
  results["res_gpu"] = paddle.incubate.nn.functional.fused_multi_head_attention(x=arg_1,qkv_weight=arg_2,linear_weight=arg_3,pre_layer_norm=arg_4,pre_ln_scale=arg_5,pre_ln_bias=arg_6,ln_scale=arg_7,ln_bias=arg_8,pre_ln_epsilon=arg_9,qkv_bias=arg_10,linear_bias=arg_11,cache_kv=arg_12,attn_mask=arg_13,dropout_rate=arg_14,attn_dropout_rate=arg_15,ln_epsilon=arg_16,training=arg_17,ring_id=arg_18,name=arg_19,)
except Exception as e:
