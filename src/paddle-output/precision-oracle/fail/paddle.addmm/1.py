...
import paddle
import time
arg_1_tensor = paddle.randint(-256,1,[2, 2], dtype=paddle.float16)
arg_1 = arg_1_tensor.clone()
arg_2_tensor = paddle.randint(-8,128,[2, 2, 1], dtype=paddle.float16)
arg_2 = arg_2_tensor.clone()
arg_3_tensor = paddle.randint(-1,256,[2, 2], dtype=paddle.float16)
