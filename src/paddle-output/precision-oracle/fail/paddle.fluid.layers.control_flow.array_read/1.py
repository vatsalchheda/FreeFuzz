...
start = time.time()
results["time_low"] = paddle.fluid.layers.control_flow.array_read(array=arg_1,i=arg_2,)
results["time_low"] = time.time() - start
arg_1 = arg_1_tensor.clone().astype(paddle.float32)
arg_2 = arg_2_tensor.clone().astype(paddle.int64)
start = time.time()
results["time_high"] = paddle.fluid.layers.control_flow.array_read(array=arg_1,i=arg_2,)
