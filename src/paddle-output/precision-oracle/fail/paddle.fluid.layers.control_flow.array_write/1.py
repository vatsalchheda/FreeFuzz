...
start = time.time()
results["time_low"] = paddle.fluid.layers.control_flow.array_write(arg_1,i=arg_2,array=arg_3,)
results["time_low"] = time.time() - start
arg_1 = arg_1_tensor.clone().type(paddle.float32)
arg_2 = arg_2_tensor.clone().type(paddle.int64)
arg_3 = arg_3_tensor.clone().type(paddle.float32)
start = time.time()
results["time_high"] = paddle.fluid.layers.control_flow.array_write(arg_1,i=arg_2,array=arg_3,)
