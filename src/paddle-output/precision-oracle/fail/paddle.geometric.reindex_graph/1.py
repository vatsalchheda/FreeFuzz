...
import paddle
import time
arg_1_tensor = paddle.randint(-64,128,[0, 43], dtype=paddle.int8)
arg_1 = arg_1_tensor.clone()
arg_2_tensor = paddle.randint(-1,32,[7], dtype=paddle.int8)
arg_2 = arg_2_tensor.clone()
arg_3_0_tensor = paddle.randint(-8,4,[3], dtype=paddle.int8)
arg_3_0 = arg_3_0_tensor.clone()
arg_3_1_tensor = paddle.randint(-2,64,[3], dtype=paddle.int8)
