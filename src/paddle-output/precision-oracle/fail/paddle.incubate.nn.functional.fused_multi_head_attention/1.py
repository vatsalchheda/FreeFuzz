...
arg_7 = arg_7_tensor.clone().astype(paddle.float32)
arg_8 = arg_8_tensor.clone().astype(paddle.float32)
arg_10 = arg_10_tensor.clone().astype(paddle.float32)
arg_11 = arg_11_tensor.clone().astype(paddle.float32)
arg_13 = arg_13_tensor.clone().astype(paddle.float32)
start = time.time()
