...
import paddle
import time
arg_1_tensor = paddle.randint(-16384,4,[3, 3], dtype=paddle.float16)
arg_1 = arg_1_tensor.clone()
arg_2_tensor = paddle.randint(-1,1,[2, 1], dtype=paddle.int8)
arg_2 = arg_2_tensor.clone()
arg_3 = 27
arg_4_tensor = paddle.randint(-2048,256,[3, 2], dtype=paddle.float16)
