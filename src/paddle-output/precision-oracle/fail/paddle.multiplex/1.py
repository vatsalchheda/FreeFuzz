...
import paddle
import time
arg_1_0_tensor = paddle.randint(-1,2048,[2, 2], dtype=paddle.float16)
arg_1_0 = arg_1_0_tensor.clone()
arg_1_1_tensor = paddle.randint(-2,32,[2], dtype=paddle.float16)
arg_1_1 = arg_1_1_tensor.clone()
arg_1 = [arg_1_0,arg_1_1,]
arg_2_tensor = paddle.randint(-128,8,[2, 1], dtype=paddle.int8)
